    ...
    <div class="row mb-1">
      <div class="   col-md">
        <div class="ftco-footer-widget mb-4">
          <img src="images/canvapro.png" class="img-fluid" alt="" />
        </div>
      </div>
      <div class="col-6 col-md">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <ul class="list-unstyled">
            <li>
              <a href="index.php"><span class="icon-long-arrow-right mr-2"></span>Home</a>
            </li>
            <li>
              <a href="about.php"><span class="icon-long-arrow-right mr-2"></span>About</a>
            </li>
            <li>
              <a href="products.php"><span class="icon-long-arrow-right mr-2"></span>Products</a>
            </li>
            <li>
              <a href="blogs.php"><span class="icon-long-arrow-right mr-2"></span>Gallery</a>
            </li>
            <li>
              <a href="dealers.php"><span class="icon-long-arrow-right mr-2"></span>Dealers</a>
            </li>
            <li>
              <a href="portfolio.php"><span class="icon-long-arrow-right mr-2"></span>Portfolio</a>
            </li>
            <li>
              <a href="contact.php"><span class="icon-long-arrow-right mr-2"></span>Contact</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="col-6 col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <ul class="list-unstyled">
            ...
            <li>
              <a href="interior.php"><span class="icon-long-arrow-right mr-2"></span>Interior and Architectural Solutions </a>
            </li>
            <li>
              <a href="metalworks.php"><span class="icon-long-arrow-right mr-2"></span>
      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <ul
            ...
            <li class="ftco-animate">
              <a href="https://www.facebook.com/fotondecors"><span class="icon-facebook"></span></a>
            </li>
            <li class="ftco-animate">
...
<a href="https://api.whatsapp.com/send?phone=919346419999" style="color: #fff;" class="whatsapp-link"
  target="_blank">
