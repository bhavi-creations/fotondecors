        ...
        <div
          ...
          <div
            ...
            <div class="text">
              ...
              <p>
                we craft modern designs that blend elegance and functionality.
                Let us transform your vision into timeless spaces."
              </p>
              <p>
    ...
    <div class="slider-item js-fullheight">
      ...
      <div class="container">
        <div
          ...
          <div
            class="one-third order-md-last img js-fullheight"
            style="background-image: url(images/sliders/steel_door_window_slider.png">
            <h3 class="vr">Since - 2014</h3>
          </div>
          <div
            class="one-forth d-flex js-fullheight align-items-center ftco-animate"
    ...
    <div class="slider-item js-fullheight">
      ...
      <div class="container">
        <div
          ...
          <div
            class="one-third order-md-last img js-fullheight"
            style="background-image: url(images/sliders/upvc_windows_slider.png">
            <h3 class="vr">Since - 2014</h3>
          </div>
          <div
            class="one-forth d-flex js-fullheight align-items-center ftco-animate"
    ...
    <div class="slider-item js-fullheight">
      ...
      <div class="container">
        <div
          ...
          <div
            class="one-third order-md-last img js-fullheight"
            style="background-image: url(images/sliders/modualr_kcthen.png">
            <h3 class="vr">Since - 2014</h3>
          </div>
          <div
            class="one-forth d-flex js-fullheight align-items-center ftco-animate"
    ...
    <div class="slider-item js-fullheight">
      ...
      <div class="container">
        <div
          ...
          <div
            class="one-third order-md-last img js-fullheight"
            style="background-image: url(images/sliders/powder_coating_job_works.png">
            <h3 class="vr">Since - 2014</h3>
          </div>
          <div
            class="one-forth d-flex js-fullheight align-items-center ftco-animate"
      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-6 wrap-about pb-md-5 ftco-animate">
          ...
          <div class="pl-md-5 ml-md-5 mb-5">
            <p>
              Welcome to fotondecors.com, where architecture meets innovation
              and creativity. We specialize in designing modern, functional,
              and timeless spaces that reflect your unique vision. Our passion
              lies in transforming ideas into stunning realities, blending
              aesthetics with practicality to craft environments that inspire
              and delight.
            </p>
            <p>
              Whether it’s residential, commercial, or bespoke projects, our
              team of skilled architects and designers is dedicated to
              delivering excellence at every step. At fotondecors.in, we
              believe in pushing boundaries, redefining design standards, and
              creating spaces that stand out.
            </p>
            <p>
              Join us in building the future, one exceptional design at a
              time!
            </p>
            <p>
              <a href="about.php" class="btn-custom">Learn More <span class="ion-ios-arrow-forward"></span></a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-start mb-5  ">
        ...
        <div class="col-md-8 pl-md-5 ftco-animate">
          <div class="pl-md-4 border-line">
            <p>
              At fotondecors.com, every project is a journey we take together,
              turning your dream spaces into reality!
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-4 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-block">
            ...
            <div class="media-body p-2 mt-3">
              ...
              <p>
                "We perfectly design spaces that inspire, function seamlessly,
        ...
        <div class="col-md-4 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-block">
            ...
            <div class="media-body p-2 mt-3">
              ...
              <p>
                "We carefully plan spaces that inspire, function seamlessly,
                and stand the test of time."
              </p>
            </div>
          </div>
        ...
        <div class="col-md-4 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-block">
            ...
            <div class="media-body p-2 mt-3">
              ...
              <p>
                "We smartly execute designs that inspire, function seamlessly,
                and stand the test of time."
              </p>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row justify-content-start mb-5 pb-2">
        ...
        <div class="col-md-8 pl-md-5 heading-section ftco-animate">
          <div class="pl-md-4 border-line">
            <p>
              we take pride in delivering projects that reflect creativity,
              precision, and excellence. Each project is a testament to our
      ...
      <div class="row justify-content-center mb-5 pb-3">
        <div class="col-md-7 heading-section ftco-animate">
          ...
          <p>
            ...
            and services. Here’s what they have to say about their experience
            with us!
          </p>
        </div>
      </div>
