...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('manimalladi05@gmail.com', 'fotondecors.com' ); // Your Gmail email and name
        $mail->addAddress('manimalladi05@gmail.com', 'fotondecors.com'); // Recipient's email and name
